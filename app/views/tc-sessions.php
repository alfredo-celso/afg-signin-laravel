...
<div class="container text-center">
                    ...
                    <div class="col">
                        <div class="card border-primary mb-3" style="max-width: 18rem;" >
                            ...
                            <div class="card-footer">
                                ...
                                <a href="index.php?url=SigninForm/showPage&var=start&p_date=<?php echo $event['event_date_start']; ?>&p_tc=<?php echo $event['device_location']; ?>&p_customer=<?php echo $event['customer_name']; ?>&p_device=<?php echo $event['device_code']; ?>" class="btn btn-primary btn-lg mx-2">Signin</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
    ...
    <?php echo json_encode($filteredDataWithHour, JSON_PRETTY_PRINT); ?>
</div>
